...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  void initState() {
    ...
    Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
      ...
      _data = await ws.fiveDayForecastByLocation(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              Visibility(
                ...
                child: Container(
                  margin: EdgeInsets.only(
                      top: size.height * 0.02, right: size.width * 0.04),
              ...
              Container(
                margin: EdgeInsets.only(
                    right: size.width * 0.04, top: size.height * 0.03),
                child: searchIsVisible
                    ? InkWell(
                        onTap: () {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      "${weather!.temperature!.celsius.toString().split('.').first} C",
                                      style: GoogleFonts.cabin(
                                          color: Colors.black,
                                          fontWeight: FontWeight.w500,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Container(
                                                child: Text(
                                                  "${weather!.tempMax!.celsius.toString().split('.').first} C",
                                                  style: GoogleFonts.cabin(
                                                      color: Colors.black,
                                                      fontWeight:
                                                          FontWeight.w500,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Container(
                                                child: Text(
                                                  "${weather!.tempMin.toString().split('.').first} C",
                                                  style: GoogleFonts.cabin(
                                                      color: Colors.black,
                                                      fontWeight:
                                                          FontWeight.w500,
