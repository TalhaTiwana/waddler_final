                        ...
                        return InkWell(
                          onTap: (){
                            showBottomSheetCustom(context: context,size: size,
                                ...
                                address: snapshot.data.results![index].formattedAddress.toString(),
                                name: snapshot.data.results![index].name,
                                totalRating: snapshot.data.results![index].userRatingsTotal.toString(), phoneNumber: '');
                          },
                          child: Container(
                            margin: EdgeInsets.symmetric(horizontal: size.width*0.05,vertical: size.height*0.02),
                            width: size.width*0.9,
                            height:snapshot.data.results![index].formattedAddress.toString().length>80? size.height*0.4:size.height*0.35,
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.network("${snapshot.data.results![index].icon}",scale: 2,),
                                  ),
                                ),
                                Container(
                                          ...
                                          Container(
                                            ...
                                            child: RichText(
                                              text: TextSpan(
                                                  ...
                                                  children: [
                                                    TextSpan(text: "${snapshot.data.results![index].name}",style: TextStyle(fontSize: size.width*0.033,color: Colors.black,fontWeight: FontWeight.w700,letterSpacing: 0.8,))
                                                  ]
                                              ),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                Text("${snapshot.data.results![index].rating.toString()} ",style: TextStyle(
                                                    color: Colors.black,
                                                    fontWeight: FontWeight.w800,
                                                    fontSize: size.width*0.03
                                                ),),Text("(${snapshot.data.results![index].userRatingsTotal})")
                                              ],
                                            ),
                                          )
                                        ],
                                      ...
                                      Container(
                                        ...
                                        child: RichText(
                                          text: TextSpan(
                                              ...
                                              children: [
                                                TextSpan(text: "${snapshot.data.results![index].formattedAddress}",style: TextStyle(fontSize: size.width*0.033,color: Colors.black87,fontWeight: FontWeight.w500,letterSpacing: 0.8,))
                                              ]
                                          ),
                                        ),
                                      ),
